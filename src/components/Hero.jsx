    ...
    return (
        <div className='relative h-dvh w-screen overflow-x-hidden'>
            ...
            <div id='video-frame' className='relative z-10 h-dvh w-screen overflow-hidden rounded-lg bg-blue-75'>
                ...
                <h1 className={'hero-heading absolute bottom-5 right-5 z-40 text-blue-75 special-font'}>G<b>a</b>ming</h1>
            ...
            <h1 className={'hero-heading absolute bottom-5 right-5 text-black'}>G<b>a</b>ming</h1>
